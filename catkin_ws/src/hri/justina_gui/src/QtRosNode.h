...
public:
    ...
    ros::ServiceClient cltGetPlanAStar;
    ros::ServiceClient cltGetPlanRRT;
    ...
    bool call_get_plan_a_star(float start_x, float start_y, float goal_x, float goal_y);
    bool call_get_plan_rrt(float start_x, float start_y, float goal_x, float goal_y);
